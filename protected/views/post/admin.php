      ...
      $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
          array(
            ...
            'filter' => false,
            'htmlOptions' => array('class' => 'px-4 py-2 text-black sm:max-w-[100px] overflow-hidden'),
          ),
          array(
            'name' => 'title',
            'htmlOptions' => array('class' => 'px-4 py-2 text-black sm:max-w-[200px] overflow-hidden'),
          ...
          array(
            ...
            'htmlOptions' => array('class' => 'px-4 py-2 text-black sm:max-w-[300px] overflow-hidden text-justify'),
            'filterHtmlOptions' => array('class' => 'bg-white text-gray-800'),
          ),
          array(
            'name' => 'tags',
            'htmlOptions' => array('class' => 'px-4 py-2 text-black sm:max-w-[150px] overflow-hidden text-center'),
            'filterHtmlOptions' => array('class' => 'bg-white text-gray-800'),
          ),
          array(
            'name' => 'status',
            ...
            'htmlOptions' => array('class' => 'px-4 py-2 text-black text-center'),
            'filterHtmlOptions' => array('class' => 'bg-white text-gray-800'),
          ),
          array(
            'name' => 'create_time',
